    ...
    <div class="stagger">
      ...
      <form [formGroup]="loginForm" (ngSubmit)="onSubmit()" class="space-y-4">
        ...
        <div class="relative my-4 flex items-center justify-center">
          <div class="absolute inset-0 flex items-center"><div class="w-full border-t border-gray-200 dark:border-surface-700"></div></div>
          <span class="relative bg-white dark:bg-surface-900 px-3 text-xs text-gray-400 font-medium">Or continue with</span>
        </div>

        <!-- OAuth Social Buttons -->
        <div class="grid grid-cols-2 gap-3">
          <button type="button" (click)="loginWithGoogle()" class="btn-secondary w-full py-2.5 flex items-center justify-center gap-2">
          ...
          <button type="button" (click)="loginWithFacebook()" class="btn-secondary w-full py-2.5 flex items-center justify-center gap-2">
