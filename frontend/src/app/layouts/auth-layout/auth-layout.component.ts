...
@Component({
  ...
  template: `
    <div class="min-h-screen flex">
      ...
      <div class="hidden lg:flex lg:w-[55%]
        ...
        <div class="absolute inset-0 pointer-events-none overflow-hidden">
          <div class="absolute -top-40 -left-40 w-[500px] h-[500px] rounded-full
                      bg-white/5 blur-[80px]"></div>
          <div class="absolute -bottom-32 -right-20 w-[400px] h-[400px] rounded-full
                      bg-primary-400/15 blur-[60px]"></div>
          <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2
                      w-[700px] h-[700px] rounded-full bg-teal-500/8 blur-[100px]"></div>
          <!-- Subtle grid dots -->
        ...
        <div class="relative z-10 text-center max-w-lg w-full animate-fade-in-up">
          ...
          <div class="inline-flex items-center justify-center w-24 h-24
                      rounded-3xl bg-white/12 backdrop-blur-md
                      border border-white/20 mb-8 shadow-2xl animate-float">
          ...
          <div class="flex flex-wrap justify-center gap-2">
            <span *ngFor="let f of features"
              class="flex items-center gap-1.5 px-3.5 py-1.5 rounded-full text-xs font-semibold
