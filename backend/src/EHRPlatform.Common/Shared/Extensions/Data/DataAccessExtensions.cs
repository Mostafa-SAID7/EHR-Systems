...
///
/// For Redis caching, use CachingExtensions.AddRedisCaching() from Infrastructure.Caching.
/// For Elasticsearch search, use SearchExtensions.AddElasticsearchSearch() from Infrastructure.EventDriven.
///
