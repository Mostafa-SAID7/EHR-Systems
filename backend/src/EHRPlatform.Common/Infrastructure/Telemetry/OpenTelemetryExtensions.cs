...
public static class OpenTelemetryExtensions
{
    ...
    /// <summary>
    /// Add OpenTelemetry tracing for an EHR microservice (simple version).
    /// 
    /// This is the streamlined tracing-only version with console fallback for development.
    /// For comprehensive observability (metrics + traces + logs), use AddOpenTelemetryObservability.
    /// 
    /// Instruments:
