...
using EHRPlatform.Common.Shared.DTOs.Search;
using SearchQueryDto = EHRPlatform.Common.Shared.DTOs.Search.SearchQuery;
...
public sealed class ElasticsearchService : ISearchService
{
    ...
    private static Query BuildQuery(SearchQueryDto query)
    {
