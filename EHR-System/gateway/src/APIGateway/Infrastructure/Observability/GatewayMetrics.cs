...
namespace EHRPlatform.Gateway.Infrastructure.Observability
{
    ...
    public class GatewayMetrics : IGatewayMetrics
    {
        ...
        /// <summary>
        /// Record total request count by service and endpoint.
        /// </summary>
        ...
        /// <summary>
        /// Track currently active requests being processed.
        /// </summary>
        ...
        /// <summary>
        /// Record when rate limiting rejects a request.
        /// </summary>
        ...
        /// <summary>
        /// Record cache hit for response aggregation.
        /// </summary>
        ...
        /// <summary>
        /// Record cache miss for response aggregation.
        /// </summary>
    ...
    public static class MetricsExtensions
    {
        ...
        public static IApplicationBuilder UseGatewayMetrics(this IApplicationBuilder app)
        {
            ...
            // This will be accessed at http://gateway:5000/metrics
            return app;
        }
    }
}
