...
public static class IdentityMetricsExtensions
{
    ...
    /// 
    /// Examples:
    ///   /api/patients/123          â†’ patients
    ///   /api/appointments/456      â†’ appointments
    ///   /api/clinical/records/789  â†’ clinical
    ///   /health                    â†’ health
    /// 
...
public static class IdentityMetricsRecorder
{
    ...
    /// 
    /// NOTE: Do NOT use email or user_id as labels â€” these are high-cardinality (unique per user).
    ...
    /// 
    /// NOTE: Do NOT use email as a label â€” this is high-cardinality (unique).
    ...
    /// 
    /// NOTE: Do NOT use user_id as a label â€” this is high-cardinality (unique per user).
    ...
    /// Examples:
    ///   /api/patients/123/records â†’ patients
    ///   /api/appointments/456     â†’ appointments
    ///   /api/clinical/diagnoses   â†’ clinical
    /// </summary>
